...
export class InitialSetup1774235562328 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "task" RENAME COLUMN "userId" TO "projectId"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."project_status_enum" AS ENUM('active', 'archived', 'completed', 'canceled')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "task" RENAME COLUMN "projectId" TO "userId"`,
    );
    await queryRunner.query(
